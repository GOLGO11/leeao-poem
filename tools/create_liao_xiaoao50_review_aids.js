...
const outJson = path.join("analysis", "liao_xiaoao50_quote_candidates.json");
const outTsv = path.join("analysis", "liao_xiaoao50_review_candidates.tsv");
...
const triggerPatterns = [
  [
    "classics",
    /古人|古语|古话|古训|孔子|孟子|老子|庄子|荀子|韩非|论语|左传|史记|汉书|后汉书|资治通鉴|诗经|礼记|易经|周易|楚辞|唐诗|宋词|三国|西游记|红楼梦|世说|项羽|文天祥|龚定庵|苏轼|杜甫|李白|白居易|韩愈|柳宗元|司马迁|陶渊明|关公|包公|关汉卿|郑成功|五四/,
  ],
  [
    "proverb",
  ...
  [
    "foreign",
    /英文|英语|法文|德文|拉丁|希腊|圣经|新约|旧约|耶稣|莎士比亚|培根|尼采|叔本华|蒙田|罗素|马克·吐温|Lincoln|Churchill|Latin|Bible|Aesop|Montaigne|Shakespeare|Nietzsche|Higgins/,
  ],
];

const politicalPattern =
  /国民党|共产党|中共|党外|民进党|政府|政权|总统|领导|国父|革命|反共|反攻|复国|政治|政党|民主|自由|人权|宪法|司法|法院|法官|检察|判决|诉讼|自诉|诽谤|官司|警察|行政院|新闻局|外交部|财政部|国防部|税捐|监察院|立法院|国会|军法|特务|情报|监狱|台湾|大陆|中国|台独|统一|一国两制|省籍|本省|外省|蒋介石|蒋经国|孙中山|陈水扁|李登辉|邓小平|江鹏坚|林洋港|吴伯雄|李光耀|张温鹰|王作荣|方素敏|马英九|秦孝仪|吴大猷|王世杰|胡秋原|石永贵|梁肃戎|中央日报|三军总医院|司法院|最高法院|高等法院|台北地院|警总|法务部|施启扬|钟曜唐|翁岳生|吕德|陈重瑜|施俊尧|陈国梁|刘景星|张连财|李远哲|殷海光|郑成功|五四|胡适/;

...
const sourceDir = path.join("《大李敖全集6.0》分章节", "014.台湾史政类", "006.给台湾人难看");
const outJson = path.join("analysis", "liao_make_taiwanren_look_bad_quote_candidates.json");
const outTsv = path.join("analysis", "liao_make_taiwanren_look_bad_review_candidates.tsv");
...
const triggerPatterns = [
  [
    "classics",
    /古人|古语|古话|古训|孔子|孟子|老子|庄子|荀子|韩非|论语|左传|史记|汉书|后汉书|资治通鉴|诗经|礼记|易经|周易|楚辞|唐诗|宋词|三国|西游记|红楼梦|世说|项羽|文天祥|苏轼|杜甫|李白|白居易|韩愈|柳宗元|司马迁|陶渊明|龚定庵/,
  ],
  [
    "proverb",
    /俗话|俗语|谚语|成语|格言|名言|名句|典故|歇后语|老话|座右铭|口头禅|寓言|警句|俗谚/,
  ],
  [
    "poem",
...
const politicalPattern =
  /国民党|共产党|中共|党外|民进党|政府|政权|总统|领袖|国父|革命|反共|反攻|复国|政治|政党|民主|自由|人权|宪法|司法|法院|法官|戒严|军法|特务|情报|监狱|自诉|诽谤|选举|立法院|监察院|行政院|国会|台湾|大陆|中国|台独|统一|省籍|本省|外省|蒋介石|蒋经国|孙中山|陈水扁|李登辉|林洋港|连战|辜振甫|高玉树|吴三连|康宁祥|朱高正|邱义仁/;

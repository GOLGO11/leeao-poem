...
const BOOK = "我们没有明天";
const OUT_JSON = path.join(ROOT, "analysis", "liao_no_tomorrow_quote_candidates.json");
const OUT_TSV = path.join(ROOT, "analysis", "liao_no_tomorrow_review_candidates.tsv");
...
const quotePattern = /[“‘《「『]([^”’》」』]{1,460})[”’》」』]/g;
const triggerPatterns = [
  [
    "classics",
    /古人|古语|古话|古训|孔子|孟子|老子|庄子|荀子|韩非|墨子|论语|左传|史记|汉书|后汉书|资治通鉴|诗经|尚书|礼记|易经|周易|楚辞|三国|世说|红楼梦|水浒|西游|文天祥|龚定庵|苏轼|杜甫|李白|白居易|王安石|赵翼|司马迁|司马相如|关公|夜郎|南越|晏子|项羽|刘邦|陶渊明|屈原|孙子|兵法/,
  ],
  [
    "proverb",
    /俗话|俗语|谚语|成语|格言|名言|名句|典故|歇后语|老话|座右铭|口头禅|寓言|箴言|故事|笑话|比喻/,
  ],
  ["poem", /诗|词|歌|赋|联|对联|挽联|楹联|题辞|绝句|七律|五律|歌谣|打油|诗句|诗云|寿诗|祭文/],
  [
    "religion",
    /圣经|新约|旧约|出埃及|摩西|耶和华|耶稣|上帝|佛|佛经|和尚|菩萨|如来|基督|福音|教会|牧师|长老/,
  ],
  [
    "foreign",
    /英文|英语|法文|德文|拉丁|希腊|莎士比亚|培根|尼采|叔本华|蒙田|罗素|马克·吐温|Lincoln|Churchill|Latin|Bible|Aesop|Montaigne|Shakespeare|Nietzsche|Browning|Disraeli|Johnson|Kennedy|Jefferson|Paine|Cicero/,
  ],
];

const politicalPattern =
  /国民党|共产党|中共|民进党|党外|革命|反共|反攻|复国|总统|政府|政权|国家|民族|民主|自由|人权|宪法|司法|法院|法官|政治|政党|立法院|行政院|国会|选举|戒严|特务|情报|台湾|大陆|中国|中华民国|台独|统一|本省|外省|蒋介石|蒋经国|孙中山|李登辉|陈水扁|胡秋原|亚运|联合国|美国|日本|极权|白色恐怖|高山族|长老会|国军|人权/;

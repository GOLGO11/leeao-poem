...
const sourceBookDir = fs.readdirSync(path.join(corpusDir, sectionDir)).find((name) => name.startsWith("002."));
...
const outJson = path.join("analysis", "liao_white_eye_taiwan_quote_candidates.json");
const outTsv = path.join("analysis", "liao_white_eye_taiwan_review_candidates.tsv");
const sourceDecoder = new TextDecoder("gb18030");

const quotePattern = /[“「『]([^”」』]{1,300})[”」』]/g;
const triggerPatterns = [
  ["classics", /古人|古语|古训|古话|所谓|孔子|孟子|老子|庄子|韩非|荀子|论语|孟子|左传|史记|汉书|后汉书|资治通鉴|诗经|礼记|易经|周易|说苑|圣经|佛|禅|苏轼|杜甫|李白|白居易|龚自珍|红楼梦|水浒|三国|世说|通典|容斋|仪礼|大戴礼|文天祥|项羽|荆轲|司马迁|荀悦|陈情表|伊索/],
  ["proverb", /俗话|俗语|谚|成语|常言|格言|名言|名句|典故|歇后语|老话|土话|夫子自道/],
  ["poem", /诗|词|歌|联|对联|题词|挽联|楹联|歌谣|打油|绝句|律诗/],
  ["foreign", /英文|英语|拉丁|希腊|莎士比亚|培根|叔本华|尼采|Montaigne|English|Latin|Churchill|Lincoln|Byron|Johnson|Tolstoy|Butler|Ibsen|Aesop|伊索|Dante|Lenin|Marx/],
];
const politicalPattern =
  /国民党|共产党|中共|民进党|党外|革命|反共|反攻|复国|总统|政府|军|兵|宪法|司法|特务|情报|国家|民族|民主|自由|人权|党|领袖|国父|蒋|孙中山|台湾|大陆|统一|独立|匪|叛乱|司法院|行政院|立法院|监察院|考试院|选举|戒严|政治|政党|党报|台独|本省|外省|法院|法官|自诉|诽谤/;

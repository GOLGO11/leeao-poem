...
const outJson = path.join("analysis", "liao_naoya_quote_candidates.json");
const outTsv = path.join("analysis", "liao_naoya_review_candidates.tsv");
...
const politicalPattern =
  /国民党|共产党|中共|党外|民进党|政府|政权|总统|领导|国父|革命|反共|反攻|复国|政治|政党|民主|自由|人权|宪法|司法|法院|法官|检察|判决|诉讼|自诉|诽谤|官司|警察|行政院|新闻局|外交部|财政部|国防部|税捐|监察院|立法院|国会|军法|特务|情报|监狱|台湾|大陆|中国|台独|统一|省籍|本省|外省|蒋介石|蒋经国|孙中山|陈水扁|李登辉|邓小平|江鹏坚/;

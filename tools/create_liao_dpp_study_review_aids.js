...
if (!bookDir) throw new Error("Book directory 004 not found");
...
const quotePattern = /[“「『]([^”」』]{1,360})[”」』]/g;
const triggerPatterns = [
  { name: "classics", pattern: /孔子|孟子|庄子|老子|论语|史记|礼记|诗经|左传|春秋|资治通鉴|战国策|韩非|荀子|楚辞|汉书|唐诗|宋词|古人|古语|成语|典故|古典|曰|云|所谓|谚|俗话|歇后语/ },
  { name: "poem", pattern: /诗|词|句|联|歌|赋|七绝|五绝|唐诗|宋词|苏轼|杜甫|李白|白居易|王维|陆游|辛弃疾/ },
  { name: "foreign", pattern: /英文|法文|拉丁|希腊|美国|英国|法国|德国|俄国|日本|教皇|圣经|新约|旧约|耶稣|拿破仑|甘地|罗素|莎士比亚|J\.|W\.|[A-Za-z]{4,}/ },
  { name: "proverb", pattern: /谚语|俗语|俗话|格言|名言|座右铭|歇后语|说法|口头禅/ },
];

const politicalPattern =
  /国民党|共产党|中共|民进党|党外|新党|三民主义|政治|政党|政府|政权|总统|领袖|国父|革命|反共|反攻|复国|统一|独立|台独|民主|自由|人权|宪法|司法|法院|法官|自诉|诽谤|戒严|军法|选举|立委|国大|立法院|监察院|行政院|考试院|司法院|台湾|大陆|中国|蒋|孙中山|李登辉|陈水扁|郑南榕|康宁祥|朱高正|费希平|尤清|蓬莱岛|美丽岛/;
...
const outJson = path.join("analysis", "liao_dpp_study_quote_candidates.json");
const outTsv = path.join("analysis", "liao_dpp_study_review_candidates.tsv");

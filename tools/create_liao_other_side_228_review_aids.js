...
const outJson = path.join("analysis", "liao_other_side_228_quote_candidates.json");
const outTsv = path.join("analysis", "liao_other_side_228_review_candidates.tsv");
...
const triggerPatterns = [
  [
    "classics",
    /古人|古语|古话|古训|孔子|孟子|老子|庄子|荀子|韩非|论语|左传|史记|汉书|后汉书|资治通鉴|诗经|礼记|易经|周易|楚辞|唐诗|宋词|三国|西游记|红楼梦|世说|项羽|文天祥|龚定庵|苏轼|杜甫|李白|白居易|韩愈|柳宗元|司马迁|陶渊明/,
  ],
  [
    "proverb",
  ...
  [
    "poem",
    /诗|词|歌|赋|联|对联|挽联|楹联|题词|绝句|七律|五律|歌谣|民谣|打油/,
  ],
  [
    "foreign",
...
const politicalPattern =
  /二二八|国民党|共产党|中共|党外|民进党|政府|政权|总统|领袖|国父|革命|反共|反攻|复国|政治|政党|民主|自由|人权|宪法|司法|法院|法官|戒严|军法|特务|情报|监狱|自诉|诽谤|选举|立法院|监察院|行政院|国会|中央|台湾|大陆|中国|台独|统一|省籍|本省|外省|蒋介石|蒋经国|孙中山|陈水扁|李登辉|陈仪|白崇禧|彭孟缉|俞国华|侯素心/;

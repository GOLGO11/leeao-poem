...
const sourceRoot =
  process.argv[2] ||
  path.join("《大李敖全集6.0》分章节", "003.惊世杂文类", "004.上下古今谈");
const candidatePath =
  process.argv[3] || path.join("analysis", "liao_shangxia_gujin_quote_candidates.json");
const prefix = "liao_shangxia_gujin";
...
const keywordPattern =
  /诗|词|歌|谣|俗话|俗语|谚语|古语|古话|古训|成语|名言|名句|格言|联语|对联|所谓|曰|云|说过|有言|孔子|孟子|庄子|老子|荀子|韩非子|墨子|论语|礼记|大学|中庸|诗经|尚书|易经|周易|春秋|左传|国语|史记|汉书|后汉书|资治通鉴|世说新语|西游记|水浒传|红楼梦|三国演义|金瓶梅|佛经|金刚经|圣经|韩愈|杜甫|李白|白居易|苏轼|苏东坡|王安石|欧阳修|陆游|陶潜|陶渊明|龚自珍|顾亭林|鲁迅|胡适|梁启超|莎士比亚|歌德|尼采|柏拉图|亚里士多德|罗素|奥威尔|伏尔泰|堂吉诃德|巴尔扎克|人间喜剧|王宝钏|关公|曹操/;
const quoteContextPattern =
  /诗|词|歌|谣|俗话|俗语|谚语|古语|古话|古训|成语|名言|名句|格言|联语|对联|所谓|曰|云|说过|引用|引|有言|孔子|孟子|庄子|老子|荀子|韩非子|墨子|论语|礼记|诗经|尚书|易经|周易|春秋|左传|史记|汉书|后汉书|资治通鉴|世说新语|西游记|水浒传|红楼梦|三国演义|金瓶梅|佛经|金刚经|圣经|韩愈|杜甫|李白|白居易|苏轼|王安石|陆游|陶潜|陶渊明|鲁迅|胡适|梁启超|莎士比亚|歌德|尼采|罗素|奥威尔|伏尔泰|堂吉诃德|巴尔扎克|人间喜剧|王宝钏|关公|曹操/;
const highRiskPattern =
  /政治|政党|政府|国民党|共产党|民主|独裁|革命|反共|苏联|美国|法律|法院|判决|处罚|流氓|公娼|废娼|社会|制度|行政|政策|教育|大学|教授|报纸|新闻|社论|杂志|播音|自力报复|原子弹|私案|武侠小说|明星|爸爸犯了罪|红灯|特务/;
  ...
  if (highRiskPattern.test(`${text} ${context}`)) {
    ...
    if (!highRiskSeen.has(key)) {
      ...
      highRiskRows.push([
        ...
        row.line,
        text,
        "modern-social-political-legal-context",
        compact(context, 420),
      ]);
    }
  }

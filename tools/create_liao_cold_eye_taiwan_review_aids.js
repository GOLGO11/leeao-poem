...
const sourceDir = path.join("《大李敖全集6.0》分章节", "014.台湾史政类", "001.冷眼看台湾");
const outJson = path.join("analysis", "liao_cold_eye_taiwan_quote_candidates.json");
const outTsv = path.join("analysis", "liao_cold_eye_taiwan_review_candidates.tsv");
const sourceDecoder = new TextDecoder("gb18030");

const quotePattern = /[“「『]([^”」』]{1,300})[”」』]/g;
const triggerPatterns = [
  ["classics", /古人|古语|古训|古话|曰|云|所谓|孔子|孟子|老子|庄子|韩非|荀子|论语|孟子|左传|史记|汉书|后汉书|资治通鉴|诗经|礼记|易经|周易|说苑|圣经|佛|禅|苏轼|杜甫|李白|白居易|龚自珍|红楼梦|水浒|三国|世说|通典|容斋|仪礼|大戴礼|文天祥|项羽|杜牧/],

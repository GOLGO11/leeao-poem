...
const outTsv = path.join("analysis", "liao_first_class_realm_first_pass_lexicon_hits.tsv");
...
function excerpt(value, size = 300) {
...
console.log(JSON.stringify({ lexiconSize: lexicon.length, hits: uniqueHits.length, outTsv }, null, 2));

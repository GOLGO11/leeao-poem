...
const sourceRoot =
  process.argv[2] ||
  path.join("《大李敖全集6.0》分章节", "003.惊世杂文类", "003.为中国思想趋向求答案");
const candidatePath =
  process.argv[3] || path.join("analysis", "liao_thought_trend_quote_candidates.json");

const outKeywordPath = path.join("analysis", "liao_thought_trend_keyword_lines.tsv");
const outKeywordShortPath = path.join("analysis", "liao_thought_trend_keyword_lines_short.tsv");
const outPlausiblePath = path.join("analysis", "liao_thought_trend_plausible_quotes.tsv");
const outKnownMatchesPath = path.join("analysis", "liao_thought_trend_known_quote_matches.tsv");
const outHighRiskPath = path.join("analysis", "liao_thought_trend_high_risk_noise.tsv");
...
const highRiskPattern =
  /论战|文化|中西|西化|趋向|答案|本位|民族|思想|主义|政治|政党|政府|国民党|共产党|三民主义|社会主义|资本主义|自由主义|保守主义|民主|独裁|革命|反共|苏联|美国|国体|孔教|文体|社会史|科学与人生观|宣言|声明|社论|杂志|报纸|刊物|教授|学者|学校|教育|大学|总统|立法院|行政|法律|制度|政策/;
